...
var TwitterAuth = function(options) {
	if (!(this instanceof TwitterAuth))
		return new TwitterAuth(options);
...
TwitterAuth.VERSION = VERSION;

TwitterAuth.prototype.getRequestToken = function(callback) {
...
TwitterAuth.prototype.getAuthUrl = function(requestToken, options) {
	var extraArgs = "";
...
TwitterAuth.prototype.getAccessToken = function(requestToken, requestTokenSecret, oauth_verifier, callback) {
...
TwitterAuth.prototype.verifyCredentials = function(accessToken, accessTokenSecret, params, callback) {
...
// Timelines
TwitterAuth.prototype.getTimeline = function(type, params, accessToken, accessTokenSecret, callback) {
...
//Streaming
TwitterAuth.prototype.getStream = function(type, params, accessToken, accessTokenSecret, dataCallback, endCallback) {
	type = type.toLowerCase();
		...
		res.addListener("data", function(chunk) {
			if (chunk == "\r\n") {
				...
				try {
					...
					dataCallback({
						message: "Error while parsing TwitterAuth-Response.",
						error: e
					}, null, chunk, res);
					return;
				}
...
// Tweets
TwitterAuth.prototype.statuses = function(type, params, accessToken, accessTokenSecret, callback) {
...
TwitterAuth.prototype.uploadMedia = function(params, accessToken, accessTokenSecret, callback) {
	var r = request.post({
 ...
 * @param callback
 */
TwitterAuth.prototype.uploadVideo = function (params, accessToken, accessTokenSecret, callback) {
	this.uploadMediaChunked(params, "video/mp4", accessToken, accessTokenSecret, callback);
};

TwitterAuth.prototype.uploadMediaChunked = function (params, media_type, accessToken, accessTokenSecret, callback) {
...
// Search
TwitterAuth.prototype.search = function(params, accessToken, accessTokenSecret, callback) {
...
// Users
TwitterAuth.prototype.users = function(type, params, accessToken, accessTokenSecret, callback) {
	var url = type.toLowerCase();
...
TwitterAuth.prototype.friends = function(type, params, accessToken, accessTokenSecret, callback) {
...
TwitterAuth.prototype.followers = function(type, params, accessToken, accessTokenSecret, callback) {
	var url = type.toLowerCase(); // ids or list
...
// Friendships
TwitterAuth.prototype.friendships = function(type, params, accessToken, accessTokenSecret, callback) {
	var url = type.toLowerCase(); // ids or list
	var method = "GET";
...
TwitterAuth.prototype.updateProfileImage = function(params, accessToken, accessTokenSecret, callback) {
...
// Account
TwitterAuth.prototype.account = function(type, params, accessToken, accessTokenSecret, callback) {
	var url = type.toLowerCase();
...
// Blocks
TwitterAuth.prototype.blocks = function(type, params, accessToken, accessTokenSecret, callback) {
	var url = type.toLowerCase();
...
// Mutes
TwitterAuth.prototype.mutes = function(type, params, accessToken, accessTokenSecret, callback) {
	var url = type.toLowerCase();
...
// Suggestions
TwitterAuth.prototype.suggestions = function(type, params, accessToken, accessTokenSecret, callback) {
	var url = type.toLowerCase();
	var method = "GET";
...
// Favorites
TwitterAuth.prototype.favorites = function(type, params, accessToken, accessTokenSecret, callback) {
	var url = type.toLowerCase();
	var method = "GET";
...
// Direct Messages
TwitterAuth.prototype.direct_messages = function(type, params, accessToken, accessTokenSecret, callback) {
	var url = type.toLowerCase();
	var method = "GET";
...
// Lists
TwitterAuth.prototype.lists = function(type, params, accessToken, accessTokenSecret, callback) {
	var url = type.toLowerCase();
	var method = "GET";
...
// Saved Searches
TwitterAuth.prototype.savedSearches = function(type, params, accessToken, accessTokenSecret, callback) {
	var url = type.toLowerCase();
	var method = "GET";
...
// Geo
TwitterAuth.prototype.geo = function(type, params, accessToken, accessTokenSecret, callback) {
	var url = type.toLowerCase();
	var method = "GET";
...
// Trends
TwitterAuth.prototype.trends = function(type, params, accessToken, accessTokenSecret, callback) {
	var url = type.toLowerCase();
...
// Spam Reporting
TwitterAuth.prototype.report_spam = function(type, params, accessToken, accessTokenSecret, callback) {
	var url = type.toLowerCase();
...
// OAuth
TwitterAuth.prototype.oauth = function(type, params, accessToken, accessTokenSecret, callback) {
	var url = type.toLowerCase();
	var method = "GET";
...
// Help
TwitterAuth.prototype.help = function(type, params, accessToken, accessTokenSecret, callback) {
	var url = type.toLowerCase();
...
// Rate Limit Status
TwitterAuth.prototype.rateLimitStatus = function(params, accessToken, accessTokenSecret, callback) {
